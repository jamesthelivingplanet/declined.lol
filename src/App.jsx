    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black relative overflow-hidden">
      ...
      <div className="relative z-10 px-4 py-8 md:px-8">
        ...
        <header className="text-center mb-12 md:mb-16">
          ...
          <div className="max-w-4xl mx-auto">
            <p className="text-lg md:text-2xl text-cyan-400 mb-4 font-bold tracking-wide">
              ...
              <p className="text-sm md:text-lg text-gray-300 font-mono">
        ...
        <div className="max-w-6xl mx-auto mb-16">
          <div className="bg-gray-800 border-2 border-red-500 rounded-lg p-6 md:p-8 shadow-2xl relative">
            <div className="border-glitch rounded-lg overflow-hidden relative">
              ...
              <div className="relative group">
                <img 
                  ...
                  onError={(e) => {
                    e.target.src = `https://via.placeholder.com/1200x800/1f2937/ef4444?text=${encodeURIComponent(screenshots[currentIndex].title)}`
                  }}
                />
                
                {/* Navigation buttons - More aggressive styling */}
                <button 
                  className="absolute left-4 top-1/2 transform -translate-y-1/2 bg-red-500 hover:bg-red-700 text-white w-12 h-12 md:w-16 md:h-16 rounded-none font-black text-xl md:text-2xl transition-all duration-200 hover:scale-110 shadow-lg border-2 border-white"
                  onClick={goToPrevious}
                >
                  ◀
                </button>
                <button 
                  className="absolute right-4 top-1/2 transform -translate-y-1/2 bg-red-500 hover:bg-red-700 text-white w-12 h-12 md:w-16 md:h-16 rounded-none font-black text-xl md:text-2xl transition-all duration-200 hover:scale-110 shadow-lg border-2 border-white"
                  onClick={goToNext}
                >
                  ▶
                </button>
              ...
              {/* Screenshot info - Dark and sarcastic */}
              <div className="p-6 md:p-8 bg-gradient-to-b from-gray-800 to-gray-900 border-t-2 border-cyan-400">
                <div className="text-center">
                  ...
                  <p className="text-base md:text-xl text-gray-300 mb-3 font-mono leading-relaxed">
                    {screenshots[currentIndex].description}
                  </p>
                  <div className="inline-block px-4 py-2 bg-purple-500 text-black font-bold text-sm rounded border-2 border-white animate-pulse">
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="space-y-6 text-left md:text-center">
            ...
            <div className="border-2 border-red-500 bg-gray-800 p-6 rounded font-mono text-sm md:text-base">
          ...
          <div className="flex flex-col md:flex-row gap-4 justify-center mt-12">
            <a 
              href="#" 
              className="px-8 py-4 bg-red-500 hover:bg-red-700 text-white font-black text-lg md:text-xl border-4 border-white hover:border-cyan-400 transition-all duration-200 animate-pulse hover:animate-bounce tracking-wide"
              style={{fontFamily: 'Orbitron, sans-serif'}}
            >
          ...
          {/* Final message */}
          <div className="mt-12 p-6 border-2 border-purple-500 bg-gradient-to-r from-gray-800 to-gray-900 rounded">
